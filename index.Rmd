...
<h3>Upload Web Video Text Tracks (`.vtt` or `.txt` extensions)</h3>
...
<h3>Download plain transcription</h3>
...
renderUI({
  if(isTruthy(input$upload)) {
    textInput('downloaded_file_name', '[Optional] Edit file name (omitting extension)', 
